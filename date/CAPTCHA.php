<?php
/* 生成验证码序列 */
define("CAPTCHA_NUMCHARS", 5);  //验证码长度
$pass_phrase = "";              //验证码内容
...
/* 生成验证码图像 */
define("CAPTCHA_WIDTH", 100);    //验证码宽度
define("CAPTCHA_HEIGHT", 38);    //验证码高度
//创建空白画布
...
//绘制验证码
imagettftext($img, 0, 0, 0, CAPTCHA_HEIGHT, $text_color, "C:\Windows\Fonts\Comic Sans MS", $pass_phrase);
//作为PNG图像输出
